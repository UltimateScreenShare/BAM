...
Write-Host -ForegroundColor White "╚═╝╚═╝─╚╝─╚══╝╚╩═╩╝╚╝╚╝─╚╝─╚═╝     ╚══╝╚══╝";
Write-Host "";
Write-Host -ForegroundColor Gray "   Made By nico for Ultimate Screenshare (Best Course) - " -NoNewLine
Write-Host -ForegroundColor White "discord.gg/ultimatescreenshare";
Write-Host "";
...
if (!(Get-PSDrive -Name HKLM -PSProvider Registry)){
    ...
    Catch{Write-Warning "[ERROR] Error Mounting HKEY_Local_Machine"}
}
$bv = ("bam", "bam\State")
...
Catch{
    Write-Warning "[ERROR] Error Parsing BAM Key. Likely unsupported Windows Version"
    Exit
}
